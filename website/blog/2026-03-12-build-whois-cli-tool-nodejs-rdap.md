...
description: "Build a command-line domain lookup tool using Node.js and RDAPify. Supports domains, IPs, and ASNs with colored output, JSON mode, and batch queries."
...
Add shebang to the compiled output — add this to the top of `src/cli.ts`:
...
Or even simpler — RDAPify ships with a built-in CLI:
