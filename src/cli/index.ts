...
import type { DomainResponse, IPResponse, ASNResponse } from '../index';

// ---------------------------------------------------------------------------
// Types
// ---------------------------------------------------------------------------

type Command = 'domain' | 'ip' | 'asn';
      ...
      default:
        ...
        if (!arg.startsWith('-')) {
          if (result.command === null) {
            if (arg !== 'domain' && arg !== 'ip' && arg !== 'asn') {
              fatal(`Unknown command: "${arg}". Valid commands are: domain, ip, asn`);
            }
