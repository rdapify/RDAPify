...
│   │   └── credits.md
│   │
│   ├── deployment/                     # 🚀 النشر وبيئات التشغيل (جديد)
│   │   ├── docker-image.md             # الصورة الرسمية لـ Docker Hub
│   │   ├── kubernetes-deployment.md    # ملفات نشر Kubernetes (Helm/YAML)
│   │   ├── container-cli-usage.md      # استخدام أداة CLI داخل Docker
│   │   └── environment-vars.md         # متغيرات البيئة الخاصة بالحاوية
│   │
│   └── resources/
│       ├── glossary.md
│       ├── links.md
